...
root.title("Einstein Developers : 0741437712")
root.config(bg='#3e4290')

# Creating the TUC logo
image = ImageTk.PhotoImage(Image.open('logo.jpg'))
l = Label(font=("Calibri", 20), image=image)
l.config(bg="#ffffff")
l.pack(side=TOP)

'''#Creating the logo tag
B=Label(font=('Arial',20), text='EINSTEIN DEVELOPERS : THARAKA UNIVERSITY')
B.config(bg="#3e4290",width=80,height=1,fg='white',bd=2)
B.pack(side=TOP)'''

Tops = Frame(root, bg="#3e4290", width=1600, height=100, relief=SUNKEN)
Tops.pack(side=TOP)
...
# -----------------INFO TOP------------
lblinfo = Label(Tops, font=('aria', 30, 'bold'), text="TUC 🚟 Cafeteria Point of Sale System", fg="steel blue", bd=10,
                anchor='w')
...
def Ref():
    ...
    costofdrinks = codr * 10

    costofmeal = "Ksh.", str(
        '%.2f' % (costoffries + costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks))
    PayTax = ((costoffries + costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks) * 0.0)
    Totalcost = (costoffries + costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks)
    Ser_Charge = (
            (costoffries + costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks) * 0.0)
...
def print():
    ro = Tk()
    ro.title("Receipt printer")
    ro.config(bg="#ffffff")
    ro.geometry("300x300+0+0")

    l = Label(ro, font=('calibri', 12), text='---------RECEIPT----------')
    l.pack(side=TOP)

    heading = Label(ro, font=('calibri', 12), text='Item\tPRICE\tQTY\tTOTAL')
...
btnc = Button(f2, padx=16, pady=16, bd=4, fg="black", font=('ariel', 20, 'bold'), text="del", bg="powder blue",
              command=clrdisplay)
...
status = Label(f2, font=('aria', 15, 'bold'), width=20, text="ISAAC MUUO", bd=2, relief=SUNKEN)
status.grid(row=7, columnspan=3)
status = Label(f2, font=('aria', 15, 'bold'), width=20, text="EINSTEIN DEVELOPERS", bd=2, relief=SUNKEN)
...
lblfries = Label(f1, font=('aria', 16, 'bold'), text="Muthokoi", fg="steel blue", bd=10, anchor='w')
lblfries.grid(row=1, column=0)
txtfries = Entry(f1, font=('ariel', 16, 'bold'), textvariable=Fries, bd=6, insertwidth=4, bg="powder blue",
                 justify='right')
txtfries.grid(row=1, column=1)

lblLargefries = Label(f1, font=('aria', 16, 'bold'), text="Ugali Peas/Beans", fg="steel blue", bd=10, anchor='w')
lblLargefries.grid(row=2, column=0)
txtLargefries = Entry(f1, font=('ariel', 16, 'bold'), textvariable=Largefries, bd=6, insertwidth=4, bg="powder blue",
                      justify='right')
txtLargefries.grid(row=2, column=1)

lblburger = Label(f1, font=('aria', 16, 'bold'), text="Rice Beef", fg="steel blue", bd=10, anchor='w')
lblburger.grid(row=3, column=0)
txtburger = Entry(f1, font=('ariel', 16, 'bold'), textvariable=Burger, bd=6, insertwidth=4, bg="powder blue",
                  justify='right')
txtburger.grid(row=3, column=1)

lblFilet = Label(f1, font=('aria', 16, 'bold'), text="Chapati/Andazi", fg="steel blue", bd=10, anchor='w')
lblFilet.grid(row=4, column=0)
txtFilet = Entry(f1, font=('ariel', 16, 'bold'), textvariable=Filet, bd=6, insertwidth=4, bg="powder blue",
                 justify='right')
txtFilet.grid(row=4, column=1)

lblCheese_burger = Label(f1, font=('aria', 16, 'bold'), text="Rice Peas/Beans", fg="steel blue", bd=10, anchor='w')
...
# --------------------------------------------------------------------------------------
lblDrinks = Label(f1, font=('aria', 16, 'bold'), text="Tea", fg="steel blue", bd=10, anchor='w')
...
lblService_Charge = Label(f1, font=('aria', 16, 'bold'), text="TharakaUni Loyalty Bonus", fg="steel blue", bd=10,
                          anchor='w')
...
lblTax = Label(f1, font=('aria', 16, 'bold'), text="Postpaid Costs", fg="steel blue", bd=10, anchor='w')
...
btnTotal = Button(f1, padx=16, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="TOTAL",
                  bg="#3e4290", command=Ref)
btnTotal.grid(row=7, column=1)

btnTotal = Button(f1, padx=18, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="PRINT",
                  bg="#3e4290", command=print)
btnTotal.grid(row=7, column=2)

btnTotal = Button(f1, padx=12, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="SUPPORT",
                  bg="gold", command=Ref).place(x=1000, y=10)
# btnTotal.grid(row=7, column=2)

btnTotal = Button(f1, padx=12, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="I. EINSTEIN",
                  bg="cyan", command=Ref).place(x=1000, y=100)
# btnTotal.grid(row=7, column=2)

btnTotal = Button(f1, padx=12, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="THARAKAUNI",
                  bg="magenta", command=Ref).place(x=1000, y=200)
# btnTotal.grid(row=7, column=2)


btnreset = Button(f1, padx=16, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="RESET",
                  bg="#3e4290", command=reset)
btnreset.grid(row=7, column=3)

btnexit = Button(f1, padx=16, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="EXIT", bg="red",
                 command=qexit)
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Muthokoi", fg="steel blue", anchor=W)
    lblinfo.grid(row=1, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="20", fg="steel blue", anchor=W)
    lblinfo.grid(row=1, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Ugali Peas/Beans", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="20", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Rice Beef", fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="40", fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Chapati/Andazi", fg="steel blue", anchor=W)
    lblinfo.grid(row=4, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="10", fg="steel blue", anchor=W)
    lblinfo.grid(row=4, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Rice Peas/Beans", fg="steel blue", anchor=W)
...
btnprice = Button(f1, padx=5, pady=8, bd=10, fg="black", font=('ariel', 16, 'bold'), width=10, text="PRICE",
                  bg="#3e4290", command=price)
